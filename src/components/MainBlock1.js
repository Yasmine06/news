...
export default class MainBlock1 extends Component {
    constructor(props){
      super(props);
    ...
    componentDidMount() {
      ...
      fetch("https://newsapi.org/v2/top-headlines?sources=business-insider&apiKey=9827cac376e04a4ea4b26b992d5b7ef7")
           .then(d => d.json()) 
           .then(d => {
